...
SECRET_KEY = 'fvi1cc*87qn5yy&&msijf)ou6re9h36a9qoq^*-vs$5xs_sn&+'
...
# JWT 설정
# DRF(Django Rest Framework) : 모든 views.py에 적용되는 데코레이터 선언
REST_FRAMEWORK = {
...
import datetime
JWT_AUTH = {
    'JWT_EXPERATION_DELTA': datetime.timedelta(days=1)
}